...
> 自动扫描 Vault 中含「背包DP」相关关键词（背包）的笔记，按来源分组。

### 左程云
- [[牛牛的背包问题|课程/左程云/200. ★算法题目汇总★/★算法面试题汇总/牛牛的背包问题.md]]
- [[背包中有多少种零食放法|课程/左程云/200. ★算法题目汇总★/★算法面试题汇总/背包中有多少种零食放法.md]]
- [[背包能装下最多的价值|课程/左程云/200. ★算法题目汇总★/★算法面试题汇总/背包能装下最多的价值.md]]
- [[背包问题的动态规划解法|课程/左程云/200. ★算法题目汇总★/★算法面试题汇总/背包问题的动态规划解法.md]]
- [[0105-牛牛的背包问题|课程/左程云/200. ★算法题目汇总★/算法群面试题/0105-牛牛的背包问题.md]]
- [[背包问题|课程/左程云/300. 算法题目分类总结/按题目系列分类/背包问题.md]]

## 参考资料

- [[../../课程/灵茶山艾府和代码随想录/动态规划]] — 你的 DP 专题（含背包）
